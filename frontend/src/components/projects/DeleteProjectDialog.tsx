...
export function DeleteProjectDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative w-full max-w-md mx-4 rounded-xl border border-slate-700/60 bg-slate-900/95 backdrop-blur-xl shadow-2xl p-6 animate-[slideIn_0.25s_ease-out]">
        {/* Icon */}
        ...
        <h2 className="text-lg font-bold text-white mb-1">Delete Project</h2>
        <p className="text-sm text-slate-400 mb-6">
          Are you sure you want to delete{" "}
          <span className="font-semibold text-white">{projectTitle}</span>? This action cannot be
          undone and will permanently remove all tasks and members.
        </p>
